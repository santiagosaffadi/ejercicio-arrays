...
var submenus = [
    // Submenu "Shop"
    [
        ["Shop Categoris", "link.html"],
        ["Products Details", "link.html"],
        ["Product Check Out", "link.html"],
...
productosDestacados.push([
    ...
    "Beauty", "Woman Freshwash", "$150.00"
]);
productosDestacados.push([
    "img/product/product3.png",
    "Decor", "Room Flash Light", "$150.00"
]);
...
productosDestacados.push([
    ...
    "Accesories", "Man Office Bag", "$150.00",
]);

productosDestacados.push([
    "img/product/product6.png",
    "Kids Toy", "Charging Car", "$150.00"
]);

productosDestacados.push([
    "img/product/product7.png",
    "Accesories", "Blutooth Speaker", "$150.00"
]);
